...
export const SettingsModal = ({
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-2xl font-bold mb-8 text-gray-800">チャイム設定</h2>
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {settings.minutes.map((minute) => (
              ...
              >
                {minute}分<span className="text-amber-600">×</span>
              </button>
            ))}
          </div>
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3">
            <select
              ...
              onChange={(e) => onSetStartHour(parseInt(e.target.value, 10))}
            ...
            <select
              ...
              onChange={(e) => onSetEndHour(parseInt(e.target.value, 10))}
              className="px-4 py-2 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent transition-all appearance-none bg-white cursor-pointer"
            >
              {Array.from({ length: 24 }, (_, i) => (
                <option key={i} value={i}>
